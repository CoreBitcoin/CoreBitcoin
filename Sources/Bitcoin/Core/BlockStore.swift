...
public class SQLiteBlockStore: BlockStore {
    ...
    public init(file: URL, network: Network = .testnet) throws {
        ...
        // TODO: as address_id is Base58Check.encode of pubKeyHash, this works only for legacy address ?
    ...
    public func addTransaction(_ transaction: Transaction, hash: Data) throws {
        ...
        //TODO: add flag to store. If present, always 0001, and indicates the presence of witness data.
    ...
    // TODO: This looks like it calculates only for legacy addresses ?
        ...
        while sqlite3_step(stmt) == SQLITE_ROW {
            ...
            payments.append(
                Payment(state: .received,
                        index: index,
                        amount: value,
                        from: try! Address(legacy: String(cString: address)),
                        to: try! Address(legacy: String(cString: address)),
