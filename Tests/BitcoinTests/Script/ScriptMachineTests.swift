...
class ScriptMachineTests: XCTestCase {
    ...
    func testCheck() {
        ...
        let unsignedTx = Transaction(version: 1, inputs: [inputForSign], outputs: [sending, payback], witnesses: [], lockTime: 0)
        ...
        let signedTx = Transaction(version: 1, inputs: [txin], outputs: [sending, payback], witnesses: [], lockTime: 0)
