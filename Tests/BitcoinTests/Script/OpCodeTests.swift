...
class OpCodeTests: XCTestCase {
    ...
    func testOpCheckSigBTC() {
        ...
        let unsignedTx = Transaction(version: 1, inputs: [inputForSign], outputs: [], witnesses: [], lockTime: 0)
...
//
    //    let fromPublicKey = privateKey.publicKey()
//
    //    let subScript = Data(hex: //"30440220356c7a8d55d4a63b1eab9cf00886cb66fe114d31f59faf242295e0e6e2aec9e5022052b6c4ee09b6564edf5a6d13f38//6e43ca6f9b4af19e9fefea413ac28d5b8d2df41036b7b02cc5592256d22e45c2c70c41b34e962cc370bcf672cea6f476e1db318c//8")!
    //    let inputForSign = TransactionInput(previousOutput: outpoint, signatureScript: subScript, sequence: //UInt32.max)
    //    let unsignedTx = Transaction(version: 1, inputs: [inputForSign], outputs: [], witnesses: [], lockTime: 0)
//
    //    // sign
