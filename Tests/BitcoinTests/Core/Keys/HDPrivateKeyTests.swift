...
class HDPrivateKeyTests: XCTestCase {
    ...
    func testHDKey3() {
        ...
        // Generated private key was 31 bytes instead of 32.
    ...
    // Test for data size to be 32 bytes.
    // Generated private key was 31 bytes instead of 32.
    func testHDKey5() {
        ...
        XCTAssertEqual(privKey.publicKey().toAddress().legacy, "1DPUysR46jraybTwP3PfSbcBENeLScLxx")
    }
}
